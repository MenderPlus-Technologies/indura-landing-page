        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {blogPosts.map((post) => {
            ...
            return (
              <article
                key={post.title}
                className="flex flex-col rounded-lg border border-[#eceff3] bg-white overflow-hidden transition-all hover:-translate-y-1 hover:border-[#009688]/40"
              >
                ...
                <div className="flex flex-col flex-grow p-6 md:p-8">
                  ...
                  <h3 className="text-[#0d0d12] text-lg font-semibold leading-snug mb-3">
                    {post.title}
                  </h3>
                  <p className="text-[#666d80] text-sm leading-relaxed flex-grow mb-5">
                    {post.description}
                  </p>
